...
//                        IloBoolVar z_or1(env2);
//                        IloBoolVar z_or2(env2);
//                        int count1 = 0;
//                        int count2 = 0;
////                        xTemp3[4 * k + 2] = IloNumExpr(env2);
////                        xTemp3[4 * k + 3] = IloNumExpr(env2);
...
//                            {
//                                // 精度修改
//                                xTemp3[2*k] = xTemp3[2*k] + yin[j][k];
//                                count1++;
//                            }
//                            if (conflictFlightOutOut[i][j] == 1)
//                            {
//                                // 精度修改
//                                xTemp3[2*k + 1] = xTemp3[2*k + 1] + yout[j][k];
//                                count2++;
//                            }
//                            if (conflictFlightInOut[i][j] == 1)
//                            {
//                                // 精度修改
//                                xTemp3[2*k] = xTemp3[2*k] + yout[j][k];
//                                count1++;
//                            }
//                            if (conflictFlightOutIn[i][j] == 1)
//                            {
//                                // 精度修改
//                                xTemp3[2*k + 1] = xTemp3[2*k + 1] + yin[j][k];
//                                count2++;
//                            }
//                        }
//                        
...
//                        if (count1 > 0) {
//                            total++;
//                            model.add(count1*z_or1 >= xTemp3[2*k]);
//                            model.add(z2[i] + 1 >= yin[i][k] + z_or1);
//                        }
//                        if (count2 > 0) {
//                            total++;
//                            model.add(count2*z_or2 >= xTemp3[2*k + 1]);
//                            model.add(z2[i] + 1 >= yout[i][k] + z_or2);
//                        }
//                    }
//                }
//            }
